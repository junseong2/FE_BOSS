...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = async (event) => {
    ...
    try {
      ...
      loadCart();
      cartItemsStateTrigger(); // 장바구니 아이템 개수 갱신
    } catch (error) {
              ...
              <div className='mb-6 pb-6 border-b border-blue-100'>
                ...
                <div className='mt-4 space-y-3'>
                  ...
                  <div className='flex items-center text-sm'>
                    ...
                    <span className='text-gray-700'>
                      {product.deliveryTime || '오늘 주문시 내일 도착'}
                    </span>
                  </div>
                  <div className='flex items-center text-sm'>
                    ...
                    <span className='text-gray-700'>
                      구매 시{' '}
                      <span className='font-semibold'>{Math.round(product.price * 0.01)}</span>
                      포인트 적립
                    </span>
                  </div>
                </div>
              ...
              <div className='mt-6 bg-gradient-to-r from-blue-50 to-blue-100 p-5 rounded-xl border border-blue-100'>
                <div className='flex items-start'>
                  ...
                  <div className='text-sm text-gray-600'>
                    ...
                    <p>
                      본 상품은 100% 정품이며, 30일 이내 환불 가능합니다. 구매 후 문제가 있으실 경우
                      고객센터로 문의해주세요.
                    </p>
                  </div>
                </div>
                ...
                <div className='prose max-w-none'>
                  ...
                  <div className='mt-12 grid grid-cols-1 md:grid-cols-3 gap-6'>
                    ...
                    <div className='bg-blue-50 p-6 rounded-xl border border-blue-100'>
                      ...
                      <p className='text-gray-600 text-sm'>
                        주문 후 최대한 빠른 시간 내에 상품을 배송해 드립니다.
                      </p>
                    </div>
                    <div className='bg-blue-50 p-6 rounded-xl border border-blue-100'>
                      <div className='w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4'>
                    ...
                    <div className='bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-100'>
                      ...
                      <ul className='space-y-3 text-gray-700'>
                        <li className='flex items-start'>
                          ...
                          <span>
                            배송기간: {product.deliveryTime || '2~3일 소요 (주말, 공휴일 제외)'}
                          </span>
                        </li>
                        <li className='flex items-start'>
                          <span className='w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-2 flex-shrink-0'></span>
                    ...
                    <div className='bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-100'>
                      ...
                      <ul className='space-y-3 text-gray-700'>
                        ...
                        <li className='flex items-start'>
                          <span className='w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-2 flex-shrink-0'></span>
                          <span>
                            교환/반품 배송비: 단순변심 - 구매자 부담, 상품하자 - 판매자 부담
                          </span>
                        </li>
                        <li className='flex items-start'>
                          <span className='w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-2 flex-shrink-0'></span>
                          <span>
                            교환/반품 불가 사유: 고객의 사용, 소비에 의해 상품의 가치가 현저히
                            감소한 경우
                          </span>
                        </li>
                      </ul>
